//The keys to test different heuristic functions are:
//P 
//R
//S
...
int main(int argc, char* argv[])
{
	...
	{   
        ...
        if (keystate[SDL_SCANCODE_P])
        {
            if (!p_down)
            {
                //Closing to exit if statement when other key is pressed
                gAStar_diagonal.completed = false;
                gAStar_euclidean.completed = false;
                gAStar.Build(*pBot);
                p_down = true;
            }
            else
        ...
        if (keystate[SDL_SCANCODE_R])
        {
            if (!r_down)
            {
                gAStar.completed = false;
                gAStar_diagonal.completed = false;
                gAStar_euclidean.Build(*pBot);
                r_down = true;
            }
            else
            {
